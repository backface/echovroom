<template>
  <div class="about">
    ...
    <p>
      Brought to you by: <a href="https://m.ash.to">m.ash.to</a><br />
      <a href="https://echovroom.live">EchoVroom</a> is Free Software. Find it on <a href="https://github.com/backface/echovroom">github</a><br />
    </p>
...
export default {
  ...
  data() {
    return {
      email: "one@sbbivm.klm".replace(/[a-zA-Z]/g,
